goog.provide('sym_log.cljs.video');
goog.require('cljs.core');
goog.require('goog.string');
goog.require('goog.string');
goog.require('goog.events');
sym_log.cljs.video.blob2vid = (function blob2vid(blob,vidId){
...
sym_log.cljs.video.per_frame_function_example = (function per_frame_function_example(ioTarget,videoRef,FPS){
return ioTarget.innerHTML = sym_log.cljs.video.time_index_to_string.call(null,videoRef.currentTime,FPS);
});
sym_log.cljs.video.time_index_to_string = (function time_index_to_string(timevalue,FPS){
...
sym_log.cljs.video.vidWrapper = (function vidWrapper(video,FPS,per_frame_function){
var this$ = this;
this$.video = video;
this$.FPS = FPS;
this$.event_control = sym_log.cljs.video.event_control = (function event_control(action){
if(cljs.core.not.call(null,cljs.core.type.call(null,this$.timerRef)))
{} else
{}
if(cljs.core._EQ_.call(null,"stop",action))
{this$.video.pause();
return clearInterval(sym_log.cljs.video.timerRef);
} else
